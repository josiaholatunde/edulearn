...
const Sidebar = () => {
  ...
  return (
    <div style={{ display: 'flex' }}>
      <div style={{ width: '280px', color: '#fff', padding: '20px 20px 0 20px' }} className='bg-cool sidebar-container d-flex flex-column justify-content-between' >
        <div className='nav-links'>
            <ul style={{ listStyleType: 'none', padding: 0 , textAlign: 'left'}}>
            <li>
                <div className='text-white' onClick={() => renderComponent('Dashboard')}>
            ...
            <li>
                <div className='text-white' onClick={() => renderComponent('Leaderboard')}>
            ...
            <li>
                <div onClick={() => renderComponent('Questions')}>
        ...
        <div className='logout-links'>
            <ul style={{ listStyleType: 'none', padding: 0 , textAlign: 'left'}}>
                ...
                <li>
                    <div onClick={() => renderComponent('Challenges')} className='d-flex'>
      ...
      <div style={{ flex: 1, padding: '20px 20px 0 20px', height: '100vh' }}>
        {selectedComponent === 'Dashboard' && <HomePage />}
        {selectedComponent === 'Leaderboard' && <Leaderboard />}
        {selectedComponent === 'Challenges' && <Challenge />}
        {selectedComponent === 'Questions' && <Redirect to={'/questions'} />}
