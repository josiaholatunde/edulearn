...
const mapLeaderBoardUsers = (leaderboardUsers, currentPage, pageSize) => {
    ...
    return leaderboardUsers?.map((user, index) => ({
        ...
        points: user?.points ? Number(user?.points).toFixed(2) : 100,
        ...
        <div className='mt-6 leaderboard'>
            ...
            <div className='row hide-on-mobile' style={{ marginTop: '100px'}}>
                <div className={`col-md-12 d-flex justify-content-between`}>
                    ...
                    {
                        leaderboardUsers && leaderboardUsers.length >= 1 && (<div className={`card text-left mx-2 ${leaderboardUsers?.length != 2 ? 'mt-n5': ''}`} style={{ background: '#D9AF5D', height: '210px', width: '330px', outline: 'none', border: '1px solid #D9AF5D'}}>
                        <div className='card-body'>
                            <div className='row'>
                                <div className='col-md-12 d-flex align-items-center'>
